	...
	<div id="footer-wrapper">
		...
		<div id="footer-base">
			...
			$copyright_text = '&copy; ' . date( 'Y' ) . ' <a href="' . home_url( '/' ) . '" title="'. esc_attr( get_bloginfo( 'name', 'display' ) ) . '">' . esc_attr( get_bloginfo( 'name' ) ) . '</a>';
					...
					//echo $copyright_text;
					echo"Copyright © " . date( 'Y' ) ." James Cook University Brisbane (Operated by Russo Higher Education).";
				?>
			</div><!-- .copyright -->
			...
			<div class="powered">
				...
				?> -->
<p><a href="http://www.iru.edu.au/" class="footer-logo first" target="_blank" title="Innovative Research Technologies"><img src="http://testing.jcub.edu.au/wp-content/uploads/2016/08/InnovativeResearchUniversities-e1470285202630.png" alt="Innovative Research Technologies"></a>&nbsp&nbsp
<a href="http://studyinaustralia.gov.au/Sia/Splash2.aspx" class="footer-logo second" target="_blank" title="Study In Australia"><img src="http://testing.jcub.edu.au/wp-content/uploads/2016/08/AusOnlyAndFutureUnlim_V-CMYK-Coated_white-e1470284345265.png" alt="Study In Australia"></a></br>
CRICOS Provider Code: 00117J | ABN: 46253211955</p>
			</div><!-- end .powered -->
